        ...
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 product-category">
            <div class="product-image-category">
                ...
                <div class="product-icon-category">
                    <a href="{{route('web.show',$product->slug)}}" data-toggle="modal" data-target="#myModal"><i class="far fa-eye"></i></a>
            ...
            <div class="product-title-category">
                ...
                <div class="prince">{{ $product->price }}<s class="strike">$250.9</s></div>
            </div>
        </div>
    @empty
    @endforelse
